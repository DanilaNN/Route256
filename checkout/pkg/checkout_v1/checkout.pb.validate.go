...
func (m *AddToCartRequest) validate(all bool) error {
	...
	if val := m.GetCount(); val < 0 || val >= 65536 {
		err := AddToCartRequestValidationError{
			field:  "Count",
...
// Validate checks the field values on ListCartItem with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ListCartItem) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListCartItem with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ListCartItemMultiError, or
// nil if none found.
func (m *ListCartItem) ValidateAll() error {
	return m.validate(true)
}

func (m *ListCartItem) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetSku() <= 0 {
		err := ListCartItemValidationError{
			field:  "Sku",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return ListCartItemMultiError(errors)
	}

	return nil
}

// ListCartItemMultiError is an error wrapping multiple validation errors
// returned by ListCartItem.ValidateAll() if the designated constraints aren't met.
type ListCartItemMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListCartItemMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListCartItemMultiError) AllErrors() []error { return m }

// ListCartItemValidationError is the validation error returned by
// ListCartItem.Validate if the designated constraints aren't met.
type ListCartItemValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListCartItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListCartItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListCartItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListCartItemValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListCartItemValidationError) ErrorName() string { return "ListCartItemValidationError" }

// Error satisfies the builtin error interface
func (e ListCartItemValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ListCartItemValidationError{}
